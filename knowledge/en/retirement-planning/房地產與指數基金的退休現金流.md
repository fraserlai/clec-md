...
[^5]: CLEC James, long session 00508 "…HK HSBC Portfolio Loan Fully Explained" **deck**, 2025-03-22: "In the US, if the house burns down you hand it to the bank and you're fine; with a Taiwan offset mortgage, if the house burns the borrower still has to repay — you can't just walk away." Converted source: `raw/docs/簡報資料/00508…`.
