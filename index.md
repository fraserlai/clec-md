# clec.md — content index

Catalog of every knowledge page. The LLM updates this on each ingest. When
answering a query, read this first to find relevant pages, then drill in.

Format: `- [title](knowledge/<category>/<slug>.md) — one-line summary` · `zh-TW` + `en` if translated.
...
- [別為錢賣命：達到門檻就別再用生命換垃圾](knowledge/life-philosophy/別為錢賣命.md) — 15倍開始想退休、25倍就退、>50倍還上班＝換垃圾；多活十年>多工作十年；工作是選項不是判刑。 · zh-TW · en
...
- [現金是空氣，資產配置是活著](knowledge/asset-allocation/現金是空氣.md) — 現金部位、單筆買進、退休提領率四檔配置；短債≈現金、長債是風險資產。 · zh-TW · en
- [聰明再平衡法（進階／槓桿）](knowledge/asset-allocation/聰明再平衡法.md) — 上漲年削30%、下跌年補2%；不用新資金也能再平衡。 · zh-TW · en

## retirement-planning · 退休與財務規劃

- [退休需要多少錢？15 倍不是 50 倍](knowledge/retirement-planning/退休需要多少錢.md) — 年開銷15倍可退休；1440萬範例（QQQI現金流）；15年現金流≠15年現金；2.5%分水嶺；3% rule 動態提領（開銷跟資產浮動、每年reset）。 · zh-TW · en
- [三層防線：退休那年市場大跌](knowledge/retirement-planning/三層防線.md) — 三年現金墊 + 質押≤20% + 等市場回來。 · zh-TW · en
- [退休規劃的五大迷失](knowledge/retirement-planning/退休規劃的五大迷失.md) — 債券太多（FIRE銀行家34歲退休7年後失敗）、錢鎖自住房、靠出租房退休、低估通膨、迷信4%法則（花本金）；正解連向各頁（00245）。 · zh-TW · en
...
- [美國退休帳戶：只提撥 Roth，別碰 Pre-Tax](knowledge/retirement-planning/美國退休帳戶只提撥Roth.md) — Pre-Tax IRA/401K是毒藥：RMD推到最高稅率、conversion稅率仍高、變遺產雙重課稅（00551）；已卡住的用轉換計算器在低收入年慢慢轉（00476）。 · zh-TW · en
...
- [景氣循環的五個迴圈：做週期是為了心安不是報酬](knowledge/macro-economy/景氣循環與週期判讀.md) — 消費→庫存→投資→信貸→房地產；IPO/新興市場超車美國訊號；經濟指標領先/同步/落後（GDP常被大幅修正別太信）；市場四季（市場領先經濟半年）；勝率<50%，降報酬換心安。 · zh-TW · en
...
_一問再問的經典問題，一頁一題，累積歷次回答。連向 doctrine 頁而非重述。_

- [Q：我需要幾倍的年開銷才能退休？](knowledge/qa/退休需要幾倍年開銷.md) — 15倍起點；倍數隨高股息利率變（8%→25倍、約17.5倍拆解）；提領率≤3%不必高股息。 · zh-TW · en
- [Q：年輕人適合買高股息（QQQI、0056）嗎？](knowledge/qa/年輕人適合買高股息嗎.md) — 不適合；高股息是15倍退休族的現金流工具；年輕人最大風險是低報酬；把現金轉高股息會大跌。 · zh-TW · en
- [Q：Roth 和傳統 IRA 該分別放什麼資產？](knowledge/qa/帳戶類型該放什麼資產.md) — 積極的（QLD/QQQ）進免稅Roth、保守的（BOXX/QQQI/現金）進傳統；配對維持整體Beta 1.0。 · zh-TW · en
- [Q：我夠格辭掉工作、提早退休了嗎？](knowledge/qa/該不該辭職或提早退休.md) — 先算「夠不夠」再問「值不值得」；換輕鬆工作前先試算；全職投資別做成新老鼠籠；有毒環境就離開。 · zh-TW · en
- [Q：儲蓄險解約會損失本金，該現在解約還是等期滿？](knowledge/qa/保單該不該解約還是等期滿.md) — 立即解約，等期滿虧更大（沉沒成本）；解約的錢立即買指數；唯一保定期壽險與必要險（00573）。 · zh-TW · en
- [Q：退休現金流不夠，該不該以房養老？](knowledge/qa/該不該以房養老.md) — 有房又想保有它就適合；不是缺錢才用（活化資產去投資）；退休無收入辦不到理財型房貸，以房養老補位（00525/00529/00532）。 · zh-TW · en
- [Q：質押借款能不能隨資產成長把提領比例提高（4%、6%）？](knowledge/qa/質押提領比例能不能隨資產提高.md) — 不能；守提領率（433≈2%、70/30≈3%）；20%是硬上限不是提領率（跌80%照樣斷頭）；資產長大靠「重新配置」（撥兩倍借款到現金、重做433、再取2%）（00572）。 · zh-TW · en
- [Q：退休／沒工作了，勞保、國民年金還要不要繳？](knowledge/qa/勞保國保該不該繳.md) — 純用ROI算；健保強制要保；勞保/國保年資久就繳、年資淺（1:0）別繳；沒工作沒勞保很正常、不是稅無法律問題；美國Medicare B自保、癌症患者另計（00572）。 · zh-TW · en
- [Q：該不該幫朋友／親人當保人，或把錢借出去？](knowledge/qa/該不該當保人或借錢給朋友.md) — 只有願意當「丟進水溝、拿不回來」時才借／當保人；更好是直接送、說不用還；做不到直接送就別借別保；台灣舊制連帶保證追及子女（00565）。 · zh-TW · en
...
_Primary sources: 《價值十億元的投資講座》、《理財聖經 CLEC版 v3.4.1》、CLEC 策略筆記與貼文，
均在 `raw/docs/教學資料/`（本地）。Pending: CLEC寶典（與講座/聖經高度重疊）、部分貼文、
以及 `raw/transcripts/` 的影片轉錄稿（長篇轉錄進行中，見 `npm run transcribe -- --list`）。_
